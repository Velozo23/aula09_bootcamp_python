...
#Uma funcao que tranforma 
def calcular_kpi_de_funcao_de_vendas(df: pd.DataFrame) -> pd.DataFrame:
...
def pipeline_calcular_kpi_de_vendas_consolidado(pasta: str, formato_saida: list):
    ...
    data_frame_calculado = calcular_kpi_de_funcao_de_vendas(data_frame)
